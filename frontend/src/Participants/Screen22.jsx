    ...
    >
      ...
      >
        ...
        >
          <div>
            <QuestionScale
              question="1. To what extent do you think your effort is affected by the amount of fixed wage paid by the Manager?"
              name="EffortSensitivity_Manager"
              onChange={(value) => handleScaleChange("EffortSensitivity_Manager", value)}
            />
            <QuestionScale
              question="2. To what extent do you think your effort is affected by the amount of service charge/tip paid by the Customer?"
          ...
          <div>
            <QuestionScale
              question="3. To what extent do you think the Manager can observe the effort level you choose to serve the Customer?"
              name="Observability_Manager"
              onChange={(value) => handleScaleChange("Observability_Manager", value)}
            />
            <QuestionScale
              question="4. To what extent do you think the Customer can observe the effort level you choose to serve them?"
              name="Observability_Customer"
              onChange={(value) => handleScaleChange("Observability_Customer", value)}
            />
            {showSC && (
              <QuestionScale
                question="5. To what extent do you think the service charge paid by the Customer is different from the fixed wage paid by the Manager?"
                name="MentalAccount"
